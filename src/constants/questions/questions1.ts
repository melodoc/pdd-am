...
export const questions1: Array<TQuestions> = [
...

  {
    ...
    answers: [
      "1. Только пешеходам",
      "2. Только велосипедистам",
      "3. Велосипедистам и не должен создавать препятствия для пешеходов",
    ],
    correctAnswer: 2,
  },
  {
    ...
    answers: [
      "1. Уступить дорогу только пешеходам",
      "2. Уступить дорогу движущимся по ней транспортным средствам",
      "3. Уступить дорогу водителям движущихся транспортных средств и не создавать препятствия для пешеходов",
    ],
    correctAnswer: 2,
  },
  {
    ...
    answers: [
      "1. Только при видимости 100 метров с обеих сторон",
      "2. Если это не создает препятствия",
      "3. Ни в одном из случаев",
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    answers: [
      "1. Предоставляет",
      "2. Предоставляет только при перестроении",
      "3. Не предоставляет",
    ],
    correctAnswer: 2,
  },
  ...
  },
  {
    ...
    answers: [
      "1. Только правой",
      "2. По обеим параллельным полосам разрешается",
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    answers: [
      "1. Разрешается",
      "2. Разрешается, если нет транспортных средств общего пользования",
      "3. Запрещается",
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    answers: [
      "1. Возможно будет выполнить его одним действием",
      "2. Обеспечена видимость в 100 метров с обеих сторон",
      "3. Запрещается",
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    answers: [
      "1. Разрешается в условиях видимости в 100 м с обеих сторон",
      "2. Запрещается",
    ],
    correctAnswer: 0,
